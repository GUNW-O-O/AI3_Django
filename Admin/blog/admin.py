...
"""
    Django Admin 에서 모델을 관리하기 위한 설정 파일입니다.
    !!!!!!!!!!관리자 등록 방법
    1. admin.site.register(모델명)
        커스텀 : 설정 class 를 만들어서 등록할 수 있습니다.
...
#     # def user_nickname = 'user_nickname'
#     # obj = Post 객체의 nickname 반환
...
# @admin.register 를 붙히면
# admin.site.register(Post, PostAdmin) 를 사용하지 않아도 된다.
@admin.register(Post)
class PostAdmin(admin.ModelAdmin):
    # 출력 필드 설정
    list_display = (
